...
class test_parsenum(unittest.TestCase):
    ...
    def test_ints(self):
        for numstr, result in [('0', 0), ('-1', -1), ('1', 1), 
            ...
            self.assertEqual(parsenum(numstr), result)
    ...
    def test_fractions(self):
        for denomstr, denom in [('half', 2), ('third', 3), ('fourth', 4),
                ...
                ('ninetieth', 90)]:
            self.assertEqual(parsenum('one ' + denomstr), Fraction(1, denom))
            self.assertEqual(parsenum('3 ' + denomstr + 's'), Fraction(3, denom))
...
class test_sigfig_round(unittest.TestCase):
    ...
    def test_100(self):
        for x in [0, -1, 1, 109234, -120934, 1.19230413, -19203.01924,
            ...
            self.assertEqual(sigfig_round(x, 100), x)
    ...
    def test_1(self):
        for x, x_round in [(0, 0), (-1, -1), (1, 1), (109234, 100000),
            ...
            self.assertEqual(sigfig_round(x, 1), x_round)
    ...
    def test_3(self):
        for x, x_round in [(0, 0), (-1, -1), (1, 1), (109234, 109000),
            ...
            self.assertEqual(sigfig_round(x, 3), x_round)
